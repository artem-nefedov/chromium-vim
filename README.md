...
Updated to use Manifest V3 with AI (Claude).

# Where can I get cVim?

 * There are two ways:
  * You can install it through the [Chrome web store](https://chromewebstore.google.com/detail/cvim/mgpmhpoginmkljhdhjomikjhnpchgdjf)
